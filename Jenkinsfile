...
def BTSMap = ["Gungnir-assembly":"testForPiPeLine_BTS2,Gungnir-batch-topCount-monthly-BTS,testForPiPeLine_BTS3,Gungnir-batch-topCount-weekly-BTS,Gungnir-batch-topCount-BTS,Gungnir-stream-monthly-aggregates-BTS,Gungnir-stream-weekly-aggregates-BTS,Gungnir-stream-activeUser-BTS,Gungnir-stream_registeredEndpoint-BTS,Gungnir-stream_callQuality-BTS,Gungnir_stream_splitData_BTS,Gungnir-stream_callDuration-BTS,Gungnir-stream_autoLicense-BTS,Gungnir-stream_fileUsed-BTS"]
def ProdMap = ["Gungnir-assembly":"testForPiPeLine_Prod2,Gungnir-batch-topCount-monthly,Gungnir-batch-topCount-weekly,Gungnir-batch-topCount,Gungnir-stream-monthly-aggregates,Gungnir-stream-weekly-aggregates,Gungnir-stream-activeUser,Gungnir-stream_registeredEndpoint,Gungnir-stream_callQuality,Gungnir_stream_splitData,Gungnir-stream_callDuration,Gungnir-stream_autoLicense,Gungnir-stream_fileUsed"]
