...
public class DataVolumeMonitor implements Serializable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SparkDataMonitor app = new SparkDataMonitor(spark, mergedConfigProvider);


        Dataset aggregates = app.queryFunctions.cassandra.readCassandraBatch();

        Dataset data = app.allCounts(aggregates, orgId);
    ...
    public static class SparkDataMonitor{
        private SparkSession spark;
        private ConfigProvider configProvider;
        private QueryFunctions queryFunctions;

        public SparkDataMonitor(SparkSession spark, ConfigProvider configProvider) throws Exception{
            this.spark = spark;
        ...
        private Dataset allCounts(Dataset dataset, String orgId) throws Exception{
            ...
            Dataset orgIdList = spark.createDataset(getOrgList(configProvider.getAppConfig()), Encoders.STRING());
