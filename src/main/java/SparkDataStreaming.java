...
//        callQualityCount.writeStream().format("console").outputMode("update").start();
        sinkToCassandra(callQualityCount, constants.CassandraTableAgg(), "update",   "callQualityCount_" + tableProcessor.getAggregatePeriod());
    }
